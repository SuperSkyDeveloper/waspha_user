...
const NAVBAR_HEIGHT = Platform.OS === 'ios' ? 64 : 78;
const STATUSBAR_HEIGHT = Platform.OS === 'ios' ? (isIphoneX() ? 50 : 20) : 10;
...
export default {
  ...
  doubleMediumBaseMargin: ratio(48),
  tripleBaseMargin: ratio(64),
  tripleMediumBaseMargin: ratio(90),
  statusBarHeight: STATUSBAR_HEIGHT,
  horizontalLineHeight: StyleSheet.hairlineWidth,
  navBarHeight: NAVBAR_HEIGHT + STATUSBAR_HEIGHT,
  tabBarHeight: 60, // Default tab bar height in iOS 10 (source react-navigation)
  borderRadius: 5,
  borderRadiusMedium: 10,
  borderRadiusMidLarge: 15,
  borderRadiusLarge: 20,
  borderRadiusXLarge: 30,
  borderRadiusXLargeMedium: 60,
